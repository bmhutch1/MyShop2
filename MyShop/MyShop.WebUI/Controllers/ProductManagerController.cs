...
namespace MyShop.WebUI.Controllers
{
    public class ProductManagerController : Controller
    {
        ...
        {
            Product productToChange = context.Find(Id);
            ...
            else
            {
                ...
                else
                {
                    if (file != null)
                    {
                        productToChange.Image = product.Id + Path.GetExtension(file.FileName);
                        file.SaveAs(Server.MapPath("//Content//ProductImages//") + productToChange.Image);
                    }
